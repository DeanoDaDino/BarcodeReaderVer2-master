...
public class MainActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    Button btn_flash, btn_img, history1;
    boolean isOn = false;
    ...
    public void onCreate(Bundle state) {
        ...
        history1 = (Button) findViewById(R.id.history);
        ...
        history1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent regIntent = new Intent(MainActivity.this, History.class);
    ...
    public void handleResult(Result rawResult) {
        ...
        String saving = (String) rawResult.getText();
        saveFile(filename, saving);

    }

    public void saveFile(String file, String text) {
        try {
            FileOutputStream fos = openFileOutput(file, MODE_APPEND|MODE_PRIVATE);
            text += "\n";
